...
public class DicesController : MonoBehaviour {
    ...
    private void Start () {
        ...
        diceRenderer1 = this.transform.GetChild(0).gameObject.GetComponent<SpriteRenderer>();
        diceRenderer2 = this.transform.GetChild(1).gameObject.GetComponent<SpriteRenderer>();
